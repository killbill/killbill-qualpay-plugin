...
@Singleton
@Path("/healthcheck")
public class QualpayHealthcheckServlet extends PluginHealthcheck {

    private final QualpayHealthcheck healthcheck;

    @Inject
    public QualpayHealthcheckServlet(final QualpayHealthcheck healthcheck) {
